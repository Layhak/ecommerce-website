...
import { useUploadCategoryImageMutation } from '@/redux/service/product';
...
export default function CreateCategoryIconModalComponent({
  isOpen,
  onOpenChange,
}: ModalType) {
  const [uploadImage, { data, error }] = useUploadCategoryImageMutation();
              ...
              <ModalBody>
                ...
                >
                  {({ setFieldValue }) => (
                    <Form>
                      <div className="mb-5">
                        <label htmlFor="name">Category Icon Name</label>
                        <Field
                          type="text"
                          name="name"
                          id="name"
                      ...
                      <div className="mb-5">
                        <label htmlFor="fileProduct">Category Icon</label>
                        <Field
                          type="file"
                          name="fileProduct"
                          id="fileProduct"
